...
import { format as formatHTML } from "prettier";
...
export default function (eleventyConfig) {
  ...
  // Keep development HTML readable without carrying template whitespace into the output.
  eleventyConfig.addTransform("format-html", async function (content, outputPath) {
